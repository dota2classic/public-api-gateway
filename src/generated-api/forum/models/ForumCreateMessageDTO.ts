...
export function ForumCreateMessageDTOFromJSON(
  json: any,
): ForumCreateMessageDTO {
  return ForumCreateMessageDTOFromJSONTyped(json, false);
}

export function ForumCreateMessageDTOFromJSONTyped(
  json: any,
...
export function ForumCreateMessageDTOToJSON(
  value?: ForumCreateMessageDTO | null,
): any {
  if (value === undefined) {
    return undefined;
  }
