...
export function GameserverPlayerSummaryDtoFromJSON(
  json: any,
): GameserverPlayerSummaryDto {
  return GameserverPlayerSummaryDtoFromJSONTyped(json, false);
}

export function GameserverPlayerSummaryDtoFromJSONTyped(
  json: any,
...
export function GameserverPlayerSummaryDtoToJSON(
  value?: GameserverPlayerSummaryDto | null,
): any {
  if (value === undefined) {
    return undefined;
  }
