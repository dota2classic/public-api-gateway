...
export function GameserverPlayerInMatchDtoFromJSON(
  json: any,
): GameserverPlayerInMatchDto {
  return GameserverPlayerInMatchDtoFromJSONTyped(json, false);
}

export function GameserverPlayerInMatchDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    mmr: !exists(json, "mmr")
      ? undefined
      : GameserverMmrChangeDtoFromJSON(json["mmr"]),
    item0: json["item0"],
    item1: json["item1"],
    item2: json["item2"],
    item3: json["item3"],
...
export function GameserverPlayerInMatchDtoToJSON(
  value?: GameserverPlayerInMatchDto | null,
): any {
  if (value === undefined) {
    return undefined;
  }
