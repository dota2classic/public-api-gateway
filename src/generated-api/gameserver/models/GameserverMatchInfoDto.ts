...
export function GameserverMatchInfoDtoFromJSON(
  json: any,
): GameserverMatchInfoDto {
  return GameserverMatchInfoDtoFromJSONTyped(json, false);
}

export function GameserverMatchInfoDtoFromJSONTyped(
  json: any,
...
export function GameserverMatchInfoDtoToJSON(
  value?: GameserverMatchInfoDto | null,
): any {
  if (value === undefined) {
    return undefined;
  }
