...
export const PlayerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        playerControllerGetHeroPlayers: async (hero: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'hero' is not null or undefined
            if (hero === null || hero === undefined) {
                throw new RequiredError('hero','Required parameter hero was null or undefined when calling playerControllerGetHeroPlayers.');
            }
            const localVarPath = `/player/hero/{hero}/players`
...
export const PlayerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async playerControllerGetHeroPlayers(hero: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<GameserverPlayerHeroPerformance>>> {
            const localVarAxiosArgs = await PlayerApiAxiosParamCreator(configuration).playerControllerGetHeroPlayers(hero, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const PlayerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        playerControllerGetHeroPlayers(hero: string, options?: any): AxiosPromise<Array<GameserverPlayerHeroPerformance>> {
            return PlayerApiFp(configuration).playerControllerGetHeroPlayers(hero, options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @param {string} version
...
export class PlayerApi extends BaseAPI {
     ...
     * @memberof PlayerApi
     */
    public playerControllerGetHeroPlayers(hero: string, options?: any) {
        return PlayerApiFp(this.configuration).playerControllerGetHeroPlayers(hero, options).then((request) => request(this.axios, this.basePath));
    }
