...
export enum NotificationType {
  ...
  TOURNAMENT_REGISTRATION_INVITATION_CREATED = "TOURNAMENT_REGISTRATION_INVITATION_CREATED",
  TOURNAMENT_REGISTRATION_INVITATION_RESOLVED = "TOURNAMENT_REGISTRATION_INVITATION_RESOLVED",
}
