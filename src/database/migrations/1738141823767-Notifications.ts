...
export class Notifications1738141823767 implements MigrationInterface {
  name = "Notifications1738141823767";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "notification_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "steam_id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "ttl" interval NOT NULL DEFAULT '1day', "acknowledged" boolean NOT NULL DEFAULT false, "player_feedback_id" integer NOT NULL, "entity_type" character varying NOT NULL, CONSTRAINT "PK_d792aa808cb245891a5d1ee3e55" PRIMARY KEY ("id", "steam_id"))`,
    );
    await queryRunner.query(
