...
- 6–7: Систематические оскорбления одного человека на протяжении всего матча, намеренная деморализация команды
- 8–9: Угрозы, жёсткая травля с целью выжить игрока, призывы к насилию
- 10: Прямые угрозы физической расправой, нацистская символика, открытая ненависть по признаку расы/нации
...
- 7 — **лёгкое наказание** (короткий мут): агрессивные нападки на игроков, угрозы
- 8–10 — **серьёзное наказание** (мут от 1 дня и дольше): только за угрозы физической расправой, нацистскую символику, открытую ненависть по признаку расы/нации
