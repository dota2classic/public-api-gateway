...
- Единичное грубое слово в адрес игрока среди в целом нейтрального чата
...
**Транслитерация:** Игроки иногда пишут по-русски латиницей (например "huesos", "ebat", "uebishe", "degenerat", "zavali", "pizdish"). Распознавай такие слова как русский мат и оскорбления и оценивай соответственно.
