...
Для каждого игрока оцени его поведение по следующим критериям токсичности:
- Оскорбления, мат, унижения других игроков
- Расистские, националистические или дискриминирующие высказывания
- Угрозы или призывы к насилию
- Намеренная деморализация (призывы сдаться, "фид", троллинг)
- Спам или флуд в чате(обрати внимание, что сообщения начинающиеся на '-' или '/' - это команды, они не видны другим игрокам. Пример сообщений, которые не нужно учитывать для спама: '-ping', '/roll'

**Шкала messageTemperature (0–10):**
- 0 — полностью безобидное поведение
- 1–3 — лёгкая провокация или несущественные нарушения
- 4–6 — умеренная токсичность (оскорбления, негатив)
- 7–9 — явная токсичность (агрессия, систематические оскорбления)
- 10 — крайняя токсичность (угрозы, ненависть, крайние оскорбления)
