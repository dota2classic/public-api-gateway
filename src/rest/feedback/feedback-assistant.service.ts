...
[
  ...
  {"problem":["Кикает при загрузке в игру", "Отключение от сервера. вы были исключены", "отключение от сервера выгнали"],"answer": "Аккаунты Steam для подключения к игре и на сайте должны совпадать"},
